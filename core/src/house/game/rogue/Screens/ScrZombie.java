...
public class ScrZombie extends ScrBase{
    private Room room;
    private Player player;
    private Texture txt_icon;
    private Sprite spr_icon;

    public ScrZombie(MainMenu _mainMenu) {
        super();
        menu = _mainMenu;
    }
    ...
    public void show() {
        ...
        txt_icon = new Texture("zombie_button.png");
...
//     outside of the batch
        ...
        batch.draw(spr_icon, SCREEN_WIDTH - 75,0, 75,75 );
        batch.end();
